	...
	<div class="am-topbar-right">
      <div class="am-dropdown" data-am-dropdown="{boundary: '.am-topbar'}">
        <button class="am-btn am-btn-secondary am-topbar-btn am-btn-sm am-dropdown-toggle" data-am-dropdown-toggle>
        	庄金鑫<span class="am-icon-caret-down"></span>
        </button>
							...
							<div id="amz-offcanvas" class="am-offcanvas doc-offcanvas">
								<section class="amz-sidebar am-offcanvas-bar">
									<ul class="am-nav">
										...
										<li><a href="userqiuzhi.html">求职信息</a></li>
										<li><a href="useremail.html">邮件中心</a></li>
									</ul>
								</section>
							</div>
				  				...
				  				<div class="am-tabs-bd">
									<div class="am-tab-panel am-fade am-in am-active" id="tab1">
										<table class="am-table am-table-bd am-table-striped admin-content-table">
				  							<thead><tr><th>发送时间</th><th>公司名称</th><th>职位名称</th><th>状态</th></tr></thead>
											<tbody>
